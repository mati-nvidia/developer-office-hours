...
class MyExtension(omni.ext.IExt):
    def on_startup(self, ext_id):
        carb.log_info("[maticodes.doh_2022_09_02] Dev Office Hours Extension (2022-09-02) startup")
        self._window = MyWindow("MyWindow", width=300, height=300)

    def on_shutdown(self):
        carb.log_info("[maticodes.doh_2022_09_02] Dev Office Hours Extension (2022-09-02) shutdown")
        if self._window:
